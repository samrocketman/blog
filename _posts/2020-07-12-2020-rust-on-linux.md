...
> _Nov 8, 2020 update_:  Since the Sept 2020 update Rust has been broken through
> Proton.  Currently, the only way to play it is by installing steam through
> WINE.   [See this article which covers using Lutris][lutris-rust].
